...
- Customizing PivotTables (grouping, sorting, filtering)
- Creating PivotCharts for dynamic data visualization

#### Advanced Formulas and Functions
- Lookup functions: `VLOOKUP`, `HLOOKUP`, `INDEX`, `MATCH`
- Array formulas and functions
- Advanced logical functions: `IFERROR`, nested `IF`s

#### Data Analysis Tools
- Using Excel's Analysis Toolpak (descriptive statistics, regression analysis)
...
- Using form controls (buttons, drop-down lists, checkboxes)
- Combining charts, PivotTables, and slicers for dynamic reporting
...
- Basic Python syntax and data types: integers, floats, strings, lists, tuples, dictionaries
...
- Practical exercises with NumPy
...
- Setting up the SQL environment (MySQL, PostgreSQL, SQLFiddle)
...
- Aggregation with window functions: `SUM`, `AVG`, etc.
...
- `COMMIT`, `ROLLBACK`
- ACID properties
- Locks and concurrency handling

---

## 📊 Tableau

### Introduction to Tableau and Basic Data Visualization
...
- Scatter plots, area charts, bubble charts
...
- Date functions and hierarchies
- Time series analysis and forecasting

### Advanced Analysis and Dashboard Design

#### Interactive Dashboards and Stories
- Adding filters, parameters, actions
- Designing effective dashboards

#### Advanced Calculations and Analytics
- LOD (Level of Detail) expressions
- Table calculations and statistical analysis

#### Mapping and Geospatial Analysis
- Creating maps and customizing layers

#### Data Blending and Joins
- Data blending vs joining
- Unions and relationships

#### Advanced Visualization Techniques
- Tableau extensions and plugins
- Custom visuals and data storytelling

#### Performance Optimization and Best Practices
- Efficient visualizations
- Avoiding common pitfalls

#### Tableau Public and Sharing Visualizations
- Publishing to Tableau Public
- Embedding and sharing dashboards
- Managing data security and permissions

---

## 📈 Power BI

### Introduction to Power BI and Data Preparation
- Power BI Desktop, Service, Mobile overview
- Installing Power BI Desktop and interface walkthrough

### Connecting to Data Sources
- Connecting to Excel, SQL Server, Web, etc.
- ETL process with Power BI

### Data Transformation with Power Query
- Data cleaning: removing duplicates, missing values
- Pivoting, unpivoting, merging, appending
...
- Time intelligence and complex measures
...
- Maps, scatter plots, waterfall charts
...
####  GroupBy operations in Pandas :
The groupby() function in Pandas is a powerful tool used to split data into groups, apply a function (like sum, mean), and then combine the results.

#### Basic Syntax :
```python
df.groupby('column_name')
```
#### Group by one column and get the mean:
You group your data based on one column, and then calculate the average (mean) for each group.
...
data = {
    ...
    'Salary': [40000, 42000, 60000, 62000, 50000]
}
df = pd.DataFrame(data)
...
Group data based on two or more columns, then perform an operation like sum(), mean(), etc.
...
####  Get size/count of each group :
Count how many entries (rows) are in each group.

#### Example :
```python
# Count how many people in each department
